O script de teste funciona somente em ambientes Linux/MacOS e foi testado no LabGrad. Recomenda-se que os testes finais do seu trabalho sejam feitos no LabGrad, pois as versões das ferramentas instaladas nas máquinas do laboratório serão consideradas como versões de referência para a correção do trabalho.
